	...
	if config.plugins.SoftcamMenu.showEcm.value:
		skin = """
			<screen name="ScNewSelection" position="center,center" size="670,520" title="Softcam Setup">
				...
				<ePixmap pixmap="/usr/lib/enigma2/python/Plugins/Extensions/SoftcamSetup//images/div-h.png" position="0,30" zPosition="2" size="650,2" />
				<widget name="entries" position="5,35" size="630,200" />
				<ePixmap pixmap="/usr/lib/enigma2/python/Plugins/Extensions/SoftcamSetup//images/div-h.png" position="0,235" zPosition="2" size="650,2" />
				...
				<ePixmap pixmap="/usr/lib/enigma2/python/Plugins/Extensions/SoftcamSetup//images/div-h.png" position="0,470" zPosition="2" size="650,2" />
				<ePixmap position="150,510" zPosition="1" size="170,2" pixmap="/usr/lib/enigma2/python/Plugins/Extensions/SoftcamSetup/images/red.png" transparent="1" alphatest="on" />
				<ePixmap position="400,510" zPosition="1" size="170,2" pixmap="/usr/lib/enigma2/python/Plugins/Extensions/SoftcamSetup/images/green.png" transparent="1" alphatest="on" />
				...
				<ePixmap pixmap="/usr/lib/enigma2/python/Plugins/Extensions/SoftcamSetup//images/key_menu.png" position="20,480" zPosition="2" size="50,40" alphatest="on" />
			</screen>"""	
	else:
		skin = """
			<screen name="ScNewSelection" position="center,center" size="650,270" title="Softcam Setup">
				...
				<ePixmap pixmap="/usr/lib/enigma2/python/Plugins/Extensions/SoftcamSetup//images/div-h.png" position="0,215" zPosition="2" size="650,2" />
				<ePixmap position="150,260" zPosition="1" size="170,2" pixmap="/usr/lib/enigma2/python/Plugins/Extensions/SoftcamSetup/images/red.png" transparent="1" alphatest="on" />
				<ePixmap position="400,260" zPosition="1" size="170,2" pixmap="/usr/lib/enigma2/python/Plugins/Extensions/SoftcamSetup/images/green.png" transparent="1" alphatest="on" />
				...
				<ePixmap pixmap="/usr/lib/enigma2/python/Plugins/Extensions/SoftcamSetup//images/key_menu.png" position="20,230" zPosition="2" size="50,40" alphatest="on" />
			</screen>"""
...
class ScSetupScreen(Screen, ConfigListScreen):
	skin = """
		<screen position="center,center" size="570,200" title="Settings menu">
			<ePixmap position="100,30" zPosition="1" size="170,2" pixmap="/usr/lib/enigma2/python/Plugins/Extensions/SoftcamSetup/images/red.png" transparent="1" alphatest="on" />
			<ePixmap position="300,30" zPosition="1" size="170,2" pixmap="/usr/lib/enigma2/python/Plugins/Extensions/SoftcamSetup/images/green.png" transparent="1" alphatest="on" />
