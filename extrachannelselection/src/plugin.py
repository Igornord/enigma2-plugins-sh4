...
# version 2.8 - look history of version on www.vuplus.ru
#
...
def StartMainSession(reason, **kwargs):
	...
	if config.plugins.ExtraChannelSelection.enabled.value and config.plugins.ExtraChannelSelection.epgext.value:
		epgex = True
		try:
...
<screen name="ExtraChannelSelectionSetup" position="center,center" size="750,510" title="ExtraChannelSelection settings">
  ...
  <ePixmap position="535,498" zPosition="1" size="165,2" pixmap="/usr/lib/enigma2/python/Plugins/SystemPlugins/ExtraChannelSelection/images/yellow.png" alphatest="blend" />
  <widget source="yellow_key" render="Label" position="535,468" zPosition="2" size="165,30" font="Regular; 20" halign="center" valign="center" backgroundColor="#41000000" foregroundColor="#00dddddd" transparent="1" />
  <ePixmap position="290,498" zPosition="1" size="165,2" pixmap="/usr/lib/enigma2/python/Plugins/SystemPlugins/ExtraChannelSelection/images/red.png" alphatest="blend" />
  <widget source="red_key" render="Label" position="290,468" zPosition="2" size="165,30" font="Regular; 20" halign="center" valign="center" backgroundColor="#41000000" foregroundColor="#00dddddd" transparent="1" />
  <ePixmap position="45,498" zPosition="1" size="165,2" pixmap="/usr/lib/enigma2/python/Plugins/SystemPlugins/ExtraChannelSelection/images/green.png" alphatest="blend" />
  <widget source="green_key" render="Label" position="45,468" zPosition="2" size="165,30" font="Regular; 20" halign="center" valign="center" backgroundColor="#41000000" foregroundColor="#00dddddd" transparent="1" />
</screen>"""
	...
	def newConfig(self):
		...
		if cur in (self.cfg_enabled, self.cfg_text, self.cfg_barmode, self.cfg_colormode, self.cfg_piconmode, self.cfg_listmode, self.cfg_barpercmode):
			self.createSetup()
	...
	def save(self):
		...
		smooth = True if fileExists(RPATH + 'smooth') else False
		type_1 = True if fileExists(RPATH + 'type_1') else False
		type_2 = True if fileExists(RPATH + 'type_2') else False
		type_3 = True if fileExists(RPATH + 'type_3') else False
		type_4 = True if fileExists(RPATH + 'type_4') else False
