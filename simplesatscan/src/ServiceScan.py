...
class SimpleServiceScan(Screen):
	skin = """
		<screen name="SimpleServiceScan" position="340,134" size="600,502" title="Simple Service Scan">
			...
			<widget name="scan_progress" position="20,140" size="560,20" pixmap="skin_default/progress_big.png" borderWidth="1" borderColor="#cccccc" />
	...
	def __init__(self, session, scanList):
		...
		self["pass"] = Label("")
		self["servicelist"] = FIFOList(len=0)
